...
class CityDict(models.Model):
    name = models.CharField(verbose_name=u"城市名字", max_length=200)
...
class CourseOrg(models.Model):
    ...
    tag = models.CharField(verbose_name=u"机构标签", max_length=20, default="全国知名")
    category = models.CharField(verbose_name=u"机构类别", max_length=30,
    ...
    image = models.ImageField(upload_to="org/%Y/%m", max_length=200, verbose_name=u"机构logo")
    address = models.CharField(max_length=300, verbose_name=u"机构地址")
